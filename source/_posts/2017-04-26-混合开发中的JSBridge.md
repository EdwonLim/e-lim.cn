title: 移动混合开发中的 JSBridge
date: 2017-04-26
category: 大前端技术
tags: [Mobile, Bridge, Hybrid]
thumbnailImage: http://wx1.sinaimg.cn/mw690/71c50075ly1feyxr21wdkj20n905n74c.jpg
---
...
先解释一下 URL SCHEME：URL SCHEME是一种类似于url的链接，是为了方便app直接互相调用设计的，形式和普通的 url 近似，主要区别是 protocol 和 host 一般是自定义的，例如: qunarhy://hy/url?url=[http://ymfe.tech](http://ymfe.tech)，protocol 是 qunarhy，host 则是 hy。
